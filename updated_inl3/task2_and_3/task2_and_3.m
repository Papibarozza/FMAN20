...
for i = 1 : nbr_trials
    ...
    % FILL IN CODE SIMILAR TO THE TEST PART
    % ABOVE!----------------------------------------------------
    ...
    pred_train_diff_svm =  predictions_train_svm - Y_train'; % = FILL IN
    pred_train_diff_nn =  predictions_train_nn- Y_train';% = FILL IN
    err_rate_train_tree = nnz(pred_train_diff_tree) / nbr_train_examples; % = FILL IN
    err_rate_train_svm =nnz(pred_train_diff_svm) / nbr_train_examples;% = FILL IN
